//this is the page which you navigate to when time exceeds booked duration
//-------------------------------------------------------------------------
...
class ExtraFees extends StatefulWidget {
  ExtraFees({this.numOfExtraHours});
  final int numOfExtraHours;

  @override
  _ExtraFeesState createState() => _ExtraFeesState();
}

class _ExtraFeesState extends State<ExtraFees> {
          ...
          children: <Widget>[
                      ...
                      Padding(
                        ...
                        child: Card(
                          ...
                          child: Padding(
                            ...
                            child: (startTime>12 && endTime>12 )?Text(
            ...
            Card(
              child: Padding(
                padding: EdgeInsets.all(15.0),
                child: Text(
                    'You have  Extra Fees: ${(widget.numOfExtraHours) * 10} KWD'),
              ),
              elevation: 5,
            ),
            ReusableButton(
